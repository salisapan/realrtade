...
const roiTimelineData = [
  { year: '2023', expected: 8.2, actual: 8.5 },
  { year: '2024', expected: 9.1, actual: 9.4 },
  { year: '2025', expected: 10.0, actual: 10.3 },
  { year: '2026', expected: 11.2, actual: 11.5 },
  { year: '2027', expected: 12.5, actual: 0 },
  { year: '2028', expected: 13.8, actual: 0 },
];

const cashFlowQuarterlyData = [
  { name: 'Q1 2023', projected: 45000, actual: 47500 },
  { name: 'Q2 2023', projected: 48000, actual: 49200 },
  { name: 'Q3 2023', projected: 51000, actual: 50800 },
  { name: 'Q4 2023', projected: 55000, actual: 56700 },
  { name: 'Q1 2024', projected: 59000, actual: 0 },
  { name: 'Q2 2024', projected: 63000, actual: 0 },
  { name: 'Q3 2024', projected: 68000, actual: 0 },
  { name: 'Q4 2024', projected: 72000, actual: 0 },
];

const riskAssessmentData = [
  { category: 'Market', score: 3.2, fullMark: 10 },
  { category: 'Tenant', score: 2.1, fullMark: 10 },
  { category: 'Location', score: 1.5, fullMark: 10 },
  { category: 'Building', score: 2.8, fullMark: 10 },
  { category: 'Financing', score: 4.2, fullMark: 10 },
];

const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042', '#A28BFF'];

const ThreeDGraph = ({ chartId, data, type }: { chartId: string, data: any[], type: 'bar' | 'line' | 'pie' }) => {
  ...
  useEffect(() => {
    ...
    if (type === 'bar') {
      ...
      points.forEach((point) => {
        ...
        const sphereMaterial = new THREE.MeshPhongMaterial({ color: 0x00c49f });
  ...
  return (
    <div ref={containerRef} className="graph-3d-container">
      <div className="absolute top-2 left-2 text-xs text-gray-500 bg-white/80 py-1 px-2 rounded-md">
        {type === 'bar' ? 'Bar Chart' : type === 'line' ? 'Line Chart' : 'Pie Chart'}
      </div>
      <div className="absolute bottom-2 right-2 text-xs text-gray-500 bg-white/80 py-1 px-2 rounded-md">
            ...
            <div className="space-y-6">
                ...
                <div className="mt-4 md:hidden">
                  ...
                  <div className="investment-chart">
                    <ResponsiveContainer width="100%" height={200}>
                      <AreaChart data={roiTimelineData} margin={{ top: 10, right: 10, left: 0, bottom: 10 }}>
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="mt-4 md:hidden">
                  ...
                  <div className="investment-chart">
                    <ResponsiveContainer width="100%" height={200}>
                      <BarChart data={cashFlowQuarterlyData} margin={{ top: 10, right: 10, left: 0, bottom: 20 }}>
                        <CartesianGrid strokeDasharray="3 3" />
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="mt-4 md:hidden">
                  ...
                  <div className="investment-chart">
                    <ResponsiveContainer width="100%" height={200}>
                      <BarChart layout="vertical" data={riskAssessmentData} margin={{ top: 10, right: 30, left: 70, bottom: 10 }}>
                        <CartesianGrid strokeDasharray="3 3" />
