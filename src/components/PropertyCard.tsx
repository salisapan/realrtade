...
export const PropertyCard = ({
  ...
  return (
    <Card className="overflow-hidden transition-all duration-300 hover:shadow-lg animate-fade-in card-hover">
      ...
      <div className="p-4 md:p-5">
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          <a href={website} className="text-primary text-sm ml-auto hover:underline truncate">
