...
import { categories, propertiesBySector, propertiesByLowRisk, propertiesByGeography, propertiesByProfitable, propertiesByCompany } from "@/data/propertyData";
...
const Index = () => {
  ...
  return <div className="flex flex-col md:flex-row">
      ...
      <div className="flex-1 min-h-screen bg-gray-50 w-full">
        <PropertiesHeader categories={categories.map(cat => ({
        ...cat,
